...
- **Prediction**: Predict outcomes. It prefers big sample size for better prediction accuracy.
...
In healthcare research, asking the right questions and have clinical knowledge is very essential to determine the patient population and appropriate methods. Understanding the problems and using the efficient methods provides a better solutions. Maching learning method is more flexible and is better for predication and big data problems.
