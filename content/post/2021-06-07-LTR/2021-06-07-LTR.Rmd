...
For example, if we have 2 ML models to predict student's score. and our goal is to rank student. and we have below results from the models. In this case, <span style="color:red">Model 2</span> is better at ranking compared to Model 1 even though Model 1 has better prediction accuracy.
