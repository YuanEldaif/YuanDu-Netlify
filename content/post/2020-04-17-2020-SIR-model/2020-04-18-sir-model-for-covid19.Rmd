...
As shown in the picture above, there are two important rates $\beta$(transmission rate of the pathogen), $\gamma$(recovery rate). You probablily heard of the $R_0$ value (R nought).
