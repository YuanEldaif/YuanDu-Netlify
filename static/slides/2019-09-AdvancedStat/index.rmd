...
subtitle: "⚔ A general guideline"
author: "<br><br>Yuan Du"
email: "yuan.du@adventhealth.com"
date: "<br>11-07-2019<br><br>Updated: `r Sys.Date()`"
output:
...
library(tidyverse)
library(dplyr)
COPD <- read_excel("C:/Work/Project/Blogdown/Data/COPD.xlsx") 
...
--
###Patients cared under Teaching physician group has lower LOS. There is a significant lower LOS in the teaching physician group than in the non teaching group ( 3 days Vs 5 days, p-value<0.001) by Wilcoxon Mann whitney test. 
...
---
class: bg-main1
#.green[Example 5] (Paired sample t test)：
...
PairCost <- data.frame( 
                group = rep(c("Before", "After")), #, each =2277
...
.column.bg-main1[.content[
##We want to see if there is correlation between Age and Cost, a linear relationship between two continuous variables
...
.column.bg-main2[.content[
##We want to see if there is correlation between Number of consults and LOS, a monotonic relationship between two continuous or ordinal variables
...
---
class: bg-main1
#Class Activity (Outcome is .yellow[categorical] or .green[Numerical] ): 
###In groups of 2-4: Please match the statement (.green[green font]) with the appropriate statistical test (.black[black font])
<br>
###Variables include Age, Gender, Cost, LOS, Readmission, Mortality, Physician Group, Insurance type

<br>
###.purple[Note]: Assume normal distribution of Age, Cost; non-normal distribution of LOS, number of consults.
...
--
###-Construct hypothesis `r emo::ji("heavy_check_mark")`

--
###-.green[Outcome is numerical] (Parametric test & Non-parametric test) `r emo::ji("heavy_check_mark")`

--
###-.yellow[Outcome is categorical] `r emo::ji("heavy_check_mark")`
...
###*For additional hypothesis test, please refer to*  [https://stats.idre.ucla.edu/other/mult-pkg/whatstat/]()

<br/>

#Thanks!
<br/>
### My personal blog about Statistics and Data Science: [`r anicon::faa("link", animate="float", color='yellow')` <br>https://yuan-du.com]()
