...
###Estimator takes forms of weighted least squares:    
#### $$\tilde{\beta} = [\frac{1}{n} \sum_{i=1}^{n} u_i(y_i,X_i,\tilde{\beta}_0)X_iX_i^T]^{-1} \{\frac{1}{n} \sum_{i=1}^{n} v_i(y_i,X_i,\tilde{\beta}_0)y_1X_i - \omega(\tilde{\beta}_0)\}$$

--
<br>
###-"Inference for Support Vector Regression under $\mathcal{l_1}$ Regularization"
###Produced Asymptotically valid error bars $\frac{\sigma}{\sqrt{n}}$ and performed  $\mathcal{l_1}$-SVR rankscore test
---
