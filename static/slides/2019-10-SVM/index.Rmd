...
<br>
###Data was from samples of solid breast mass by using fine needle aspiration. Then features were extracted by the computer program from each one of the cells in the sample.
...
class: bg-main1
#Data Problems:
##.yellow[Data skewness & High dimensions]
